...
public class ShapeTest {
    ...
    public void testRectangleConstructor(){
        ...
        assertEquals(6,r01.getStartX(),0);
        assertEquals(5,r01.getStartY(),0);
    ...
    public void testLineConstructor(){
        ...
        assertEquals(8.53,l01.getStartX(),2);
        assertEquals(5,l01.getStartY(),0);
    ...
    public void testSquareConstructor(){
        ...
        assertEquals(7.21,s01.getStartX(),0);
        assertEquals(5.01,s01.getStartY(),0);
